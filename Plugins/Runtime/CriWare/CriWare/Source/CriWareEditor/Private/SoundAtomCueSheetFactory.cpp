...
TArray<USoundAtomCue*> USoundAtomCueSheetFactory::GetExistingCueAssets(UObject* InParent, FString PackagePath)
{
	...
	Results.RemoveAll([](USoundAtomCue* InCue) { return !IsValid(InCue); });
...
bool USoundAtomCueSheetFactory::GetImportOptions(CriAtomExAcbHn AcbHn, TArray<USoundAtomCue*> ExistingCues, bool bForceDialog)
{
