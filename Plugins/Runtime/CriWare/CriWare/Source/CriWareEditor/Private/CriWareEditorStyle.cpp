...
#if !defined(CRIWARE_UE4_LE)	/* <cri_delete_if_LE> */
void FCriWareStyle::SetupManaStyles()
{
	Set("ClassIcon.ManaTexture", new IMAGE_BRUSH("Icons/ManaTexture_16x", Icon16x16));
	Set("ClassThumbnail.ManaTexture", new IMAGE_BRUSH("Icons/ManaTexture_64x", Icon64x64));
}
#endif	/* </cri_delete_if_LE> */
