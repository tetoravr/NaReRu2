...
void FCriWareEditorModule::StartupModule()
{
	...
	RegisterAssetTypeActions(AssetTools, MakeShareable(new FManaPlayerActions(Sofdec2AssetCategoryBit)));
#endif	/* </cri_delete_if_LE> */
...
#if !defined(CRIWARE_UE4_LE)	/* <cri_delete_if_LE> */
	UThumbnailManager::Get().RegisterCustomRenderer(UManaMovie::StaticClass(), UManaMovieThumbnailRenderer::StaticClass());
#endif	/* </cri_delete_if_LE> */
}
...
#if !defined(CRIWARE_UE4_LE)	/* <cri_delete_if_LE> */
		UThumbnailManager::Get().UnregisterCustomRenderer(UManaMovie::StaticClass());
#endif	/* </cri_delete_if_LE> */
	}
}
...
{
#if !defined(CRIWARE_UE4_LE)	/* <cri_delete_if_LE> */
	for (TObjectIterator<UManaPlayer> It; It; ++It)
	{
		UManaPlayer* Player = *It;
...
void FCriWareEditorModule::HandleEditorPausePIE(bool bIsSimulating)
{
	...
	for (TObjectIterator<UManaComponent> It; It; ++It)
	{
		UManaComponent* Component = *It;
		if (Component->AffectedByPIEHandling)
		{
			(*It)->PausePIE();
		}
	}
