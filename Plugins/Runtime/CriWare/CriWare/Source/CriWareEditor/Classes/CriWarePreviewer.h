...
#if !defined(CRIWARE_UE4_LE)	/* <cri_delete_if_LE> */
	void PlayPreviewMovie(UManaMovie* Movie, UManaTexture* Texture = nullptr);
	bool IsPreviewMoviePlaying(UManaMovie* Sound);
	void StopPreviewMovie();
#endif	/* </cri_delete_if_LE> */
