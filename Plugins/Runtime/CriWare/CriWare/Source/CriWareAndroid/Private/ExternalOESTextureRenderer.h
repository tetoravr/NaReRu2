...
{
public:
	FExternalOESTextureRenderer(bool bUseOwnContext, bool bShouldUseVulkan, bool bShouldUseDesktopOpenGL);
	virtual ~FExternalOESTextureRenderer();

	bool CopyFrameTexture(int32 DestTexture, void *NativeBuffer, const FIntPoint& TextureDimensions, void* DestBuffer);
