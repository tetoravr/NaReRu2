...
/* バージョン情報 */
/* Version Number */
#define CRIATOMEX_VERSION				(0x02200200)
#define CRIATOMEX_VER_NUM				"2.20.02"
 ...
 * サウンドバッファ-への書き込み済みサンプル数、およびサンプリングレートを返します。<br>
 * 本関数は ::criAtomExPlayback_GetNumPlayedSamples 関数と異なり、
 * サウンドバッファ-に書き込まれた未出力の音声データのサンプル数を含む値を返します。
 * <br>
